#!/usr/bin/env python3
"""
CI script: Find and validate all snackpack.yaml files in the repository.
Exits with code 1 if any snackpack manifest is invalid.
"""
import os
import sys
import yaml
...
print(f"\nFound {found} snackpack manifest(s)")
if errors:
    print(f"{errors} validation error(s) found")
    sys.exit(1)
else:
    print("All snackpack manifests valid")
