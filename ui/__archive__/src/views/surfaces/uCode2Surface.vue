...
<style scoped>
.ucode2-surface {
  background: var(--usx-bg-primary, #0f172a);
  color: var(--usx-text-primary, #e2e8f0);
  font-family: var(--usx-font-body, 'Inter', system-ui, -apple-system, sans-serif);
  min-height: 100%;
  display: flex;
...
.view-tabs {
  display: flex;
  gap: 0.25rem;
  border-bottom: 1px solid var(--usx-border-color, #1e293b);
  padding-bottom: 0;
  flex-wrap: wrap;
}
...
.tab-btn {
  ...
  color: var(--usx-text-secondary, #64748b);
  font-family: inherit;
  font-size: 0.85rem;
  cursor: pointer;
...
.tab-btn:hover {
  color: var(--usx-text-primary, #e2e8f0);
  background: var(--usx-bg-tertiary, #1e293b);
}

.tab-btn.active {
  color: var(--usx-accent-color, #60a5fa);
  border-bottom-color: var(--usx-accent-color, #60a5fa);
  font-weight: 500;
}
...
.kanban-col {
  background: var(--usx-bg-tertiary, #1e293b);
  border: 1px solid var(--usx-border-color, #334155);
  border-radius: 8px;
  display: flex;
  flex-direction: column;
  overflow: hidden;
...
.kanban-col-header {
  ...
  border-bottom: 1px solid var(--usx-border-color, #334155);
  font-size: 0.85rem;
}
...
.col-title {
  font-weight: 600;
  color: var(--usx-text-heading, #f8fafc);
}

.col-count {
  margin-left: auto;
  background: var(--usx-border-color, #334155);
  color: var(--usx-text-secondary, #94a3b8);
...
.kanban-card:hover {
  border-color: var(--usx-accent-color, #60a5fa);
}
...
.status-badge.review {
  background: var(--usx-warning-bg, #451a03);
  color: var(--usx-warning-color, #fbbf24);
  border: 1px solid var(--usx-warning-border, #78350f);
}

.status-badge.published {
  background: var(--usx-success-bg, #052e16);
  color: var(--usx-success-color, #4ade80);
  border: 1px solid var(--usx-success-border, #166534);
}
...
.prose-body {
  line-height: 1.75;
  color: var(--usx-text-primary, #cbd5e1);
}
...
.prose-body blockquote {
  border-left: 3px solid var(--usx-accent-color, #60a5fa);
  padding-left: 1rem;
  margin-left: 0;
  color: var(--usx-text-secondary, #94a3b8);
  font-style: italic;
...
.toolbar-btn.primary {
  background: var(--usx-accent-color, #2563eb);
  color: #fff;
  border-color: var(--usx-accent-hover, #1d4ed8);
}

.toolbar-btn.primary:hover {
  background: var(--usx-accent-hover, #3b82f6);
}
...
.editor-textarea::placeholder {
  color: var(--usx-text-tertiary, #475569);
}

/* ─── GitHub View ─────────────────────────────────────────────── */
.github-view {
  border: 1px solid var(--usx-border-color, #30363d);
  border-radius: 6px;
  overflow: hidden;
  background: var(--usx-bg-primary, #0d1117);
}

.gh-header {
  border-bottom: 1px solid var(--usx-border-color, #21262d);
  padding: 1rem;
}
...
.gh-repo-info {
  ...
  gap: 0.75rem;
  margin-bottom: 0.75rem;
  color: var(--usx-text-primary, #c9d1d9);
}

.gh-repo-name {
  font-size: 1rem;
  font-weight: 600;
  color: var(--usx-info-color, #58a6ff);
}

.gh-repo-desc {
  font-size: 0.8rem;
  color: var(--usx-text-secondary, #8b949e);
}
...
.gh-tab.active {
  color: var(--usx-text-primary, #c9d1d9);
  border-bottom-color: var(--usx-danger-color, #f78166);
}
...
.gh-file-header {
  ...
  gap: 0.5rem;
  padding: 0.5rem 1rem;
  background: var(--usx-bg-secondary, #161b22);
  border-bottom: 1px solid var(--usx-border-color, #21262d);
  font-size: 0.8rem;
}
...
.cmd-prompt {
  color: var(--usx-success-color, #22c55e);
  font-size: 0.9rem;
  font-weight: bold;
}
