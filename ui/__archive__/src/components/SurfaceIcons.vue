<template>
  <component :is="'svg'" v-bind="iconAttrs">
    <component :is="'g'" v-html="iconPath"></component>
  </component>
</template>
...
const icons: Record<string, string> = {
  ...
  'settings': '<circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6m5.196-14.804l-4.242 4.242m-4.242 0l-4.242-4.242m16.568 7.09l-4.242-4.242m0 8.484l4.242 4.242M5.196 19.804l4.242-4.242m0-8.484l-4.242-4.242"/>',
...
const iconPath = computed(() => icons[props.name] || icons['file'])
</script>
