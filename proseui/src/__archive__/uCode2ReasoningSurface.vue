...
.reasoning-surface {
  ...
  height: 100%;
  background: var(--usx-bg-primary, #0f1117);
  color: var(--usx-text-primary, #e1e4e8);
...
.surface-badge {
  ...
  border-radius: 4px;
  background: var(--usx-accent-color, #1f6feb);
  color: #fff;
...
.status-connected .status-dot {
  background: var(--usx-success-color, #3fb950);
  box-shadow: 0 0 4px var(--usx-success-color, #3fb950);
}

.status-connecting .status-dot {
  background: var(--usx-warning-color, #d29922);
...
.status-connected {
  color: var(--usx-success-color, #3fb950);
}

.status-connecting {
  color: var(--usx-warning-color, #d29922);
}

/* ─── Model Select ────────────────────────────────────────────── */
.model-select {
  background: var(--usx-bg-tertiary, #21262d);
  color: var(--usx-text-primary, #e1e4e8);
...
.model-select:focus {
  border-color: var(--usx-accent-color, #1f6feb);
}
...
.btn-icon:hover {
  background: var(--usx-bg-hover, #30363d);
  color: var(--usx-text-primary, #e1e4e8);
}
...
.chat-container::-webkit-scrollbar-thumb {
  background: var(--usx-border-color, #30363d);
  border-radius: 3px;
}
...
.assistant-msg .msg-bubble {
  background: var(--usx-bg-secondary, #161b22);
  border: 1px solid var(--usx-border-color, #21262d);
  color: var(--usx-text-primary, #e1e4e8);
...
.thinking-dot {
  ...
  height: 6px;
  border-radius: 50%;
  background: var(--usx-text-secondary, #8b949e);
...
.msg-sources {
  ...
  margin-top: 0.5rem;
  padding-top: 0.5rem;
  border-top: 1px solid var(--usx-border-color, #21262d);
  flex-wrap: wrap;
}
...
.source-tag {
  ...
  border-radius: 3px;
  background: var(--usx-accent-color-alpha, #1f6feb20);
  color: var(--usx-info-color, #58a6ff);
  border: 1px solid var(--usx-accent-color-alpha-border, #1f6feb40);
}
...
.msg-input::placeholder {
  color: var(--usx-text-tertiary, #484f58);
}
...
.send-btn:hover:not(:disabled) {
  background: var(--usx-accent-hover, #388bfd);
}
...
.vault-dot {
  ...
  height: 5px;
  border-radius: 50%;
  background: var(--usx-text-tertiary, #484f58);
}
...
.message.error .msg-bubble {
  border-color: var(--usx-danger-color, #f85149);
  background: var(--usx-danger-bg, #2d1b1b);
}

.message.error .msg-text {
  color: var(--usx-danger-color, #f85149);
}
</style>
