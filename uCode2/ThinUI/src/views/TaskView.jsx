      ...
      <div className="taskview-table-view">
        <div className="taskview-table-bar">
          <div className="taskview-mode-switch">
            <button className={`mode-btn${viewMode === 'board' ? ' active' : ''}`} onClick={() => setViewMode('board')}>Card</button>
            <button className={`mode-btn${viewMode === 'table' ? ' active' : ''}`} onClick={() => setViewMode('table')}>List</button>
          </div>
